...
<article class="p-article">
    <div class="p-article__first">
        <h2>Take Out</h2>
        <hr>
        <figure><img src="<?php echo get_template_directory_uri(); ?>/img/front-img2.jpg" alt="Take Out"></figure>
    ...
    <div class="p-article__second">
        <h2>Eat In</h2>
        <hr>
        <figure><img src="<?php echo get_template_directory_uri(); ?>/img/front-img3.jpg" alt="Eat In"></figure>
        <div class="p-article__text">
            <div>
                <h3>小見出しが入ります</h3>
                <p>
