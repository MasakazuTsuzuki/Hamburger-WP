jQuery(document).ready(function(){
        jQuery(function($){
            ...
            jQuery('.c-button__menu').on('click', function(){
                $(".menu-cateogrymenu-container, .l-sidebar, #close-button, #smoke-layer").addClass("is-open");
                $(".content").addClass("no-scroll"); 
            });
            jQuery('.c-button__close img').on('click', function(){
                $(".menu-cateogrymenu-container, .l-sidebar, #close-button, #smoke-layer").removeClass( "is-open" );
